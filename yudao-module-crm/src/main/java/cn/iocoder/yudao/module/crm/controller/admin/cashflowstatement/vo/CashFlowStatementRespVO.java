...
@Schema(description = "管理后台 - 现金流量 Response VO")
@Data
@ExcelIgnoreUnannotated
public class CashFlowStatementRespVO {
    ...
    @ExcelProperty("报表类型（A=年报，Q1=一季报，H=半年报，Q3=三季报）")
    private String reportType;

    @Schema(description = "是否发生差错更正（1=是，0=否）")
    @ExcelProperty("是否发生差错更正（1=是，0=否）")
    private Boolean isCorrected;

    @Schema(description = "差错更正披露日期")
    @ExcelProperty("差错更正披露日期")
    ...
    @ExcelProperty("分配股利、利润或偿付利息支付的现金")
