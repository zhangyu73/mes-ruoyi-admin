...
@Schema(description = "管理后台 - 利润新增/修改 Request VO")
@Data
public class IncomeStatementSaveReqVO {
    ...
    @Schema(description = "其他综合收益(损失)")
    private String otherComprehensiveIncome;

    @Schema(description = "综合收益总额")
    private String totalComprehensiveIncome;

    @Schema(description = "归属于母公司所有者的综合收益")
    private String ociParent;

    @Schema(description = "归属于母公司其他权益工具持有者的综合收益总额")
    private String ociParentOthers;

    @Schema(description = "归属少数股东的综合收益")
